...
<Image src={img1} height={1376} alt="A farmer standing in a lush green field irrigated by a clean canal; vs, beautiful evening Aarti ceremony on the banks of the Ganga." />
...
<Image src={img2} height={1376} alt="A wooden fishing boat on a wide, calm Indian river at dawn. A fisherman is casting a net into the mist-covered water. This highlights the bridge between traditional livelihoods and modern urban water dependence." />
...
<Image src={img3} height={1376} alt="A image that captures the heartbreak of worshipping a dying physical system." />
