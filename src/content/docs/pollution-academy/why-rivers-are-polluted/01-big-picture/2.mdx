...
<Image src={img3} width={1376} alt="A beautiful, simple 3D cross-section illustration of the earth. The top layer shows a gentle river flowing between green banks. Below ground, the soil and bedrock are shown saturated with bright blue, glowing water (the aquifer). Subtle arrows should show the water seeping up from the aquifer into the river, visually explaining the concept of 'baseflow.'" />
