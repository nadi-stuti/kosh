...
In simple terms:  
First, we _dump and preserve_ everything. Later, we _refine and publish_ formal work based on this living archive, and **power real-world apps and tools** that run on top of Nadi Kosh data.

## Long-term Vision for Nadi Kosh
